...
class Save extends \Ewall\HelpDisk\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('ewall_helpdisk/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('ewall_helpdisk/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('ewall_helpdisk/*/new');
                }
                return;
            } catch (\Exception $e) {
